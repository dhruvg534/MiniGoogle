...
void Tourist::putdata()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        cout.width(30);
        cout << tourist_places[i];
        cout.setf(ios::left, ios::adjustfield);
        cout.width(120);
        cout << website[i];
        cout.setf(ios::left, ios::adjustfield);
        cout.width(10);
        cout << rating_tourist_places[i] << endl;
    }
}
...
void Hospital::putdata()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        cout << "Name:" << Hospital_name[i] << endl;
        cout << "Address:" << Hospital_address[i] << endl;
        cout << "Facility:" << Hospital_facilities[i] << endl;
        cout << "Phone Number:" << Hospital_phone[i] << endl;
        cout << "\n\n";
    }
}
...
void education::putdata(string s)
{
    ...
    for (int i = 0; i < n; i++)
    {
        if (education_type[i] == s)
        {
            ...
            cout << "Name:" << education_name[i] << endl;
            cout << "Address:" << education_address[i] << endl;
...
int main()
{
    ...
    do
    {
        ...
        try
        {
            ...
            string ss;
            cout << "----------------------------------------------"<<endl
                 << "Enter 3 to find TOURIST Places !" << endl;
            cout << "Enter 5 to find HOSPITALS !" << endl;
            cout << "Enter 7 to find HOTELS !" << endl;
            cout << "Enter 9 to find RESTAURANTS !" << endl;
            cout << "Enter 11 to find EDUCATIONAL-INSTITUTE !" << endl;
            ...
            if (choice == 3 || choice == 5 || choice == 7 || choice == 9 || choice == 11)
            {
                if (choice == 11)
                {
                    ...
                    cout << "  C for colleges/universities\n";
                    cout << "  IIT-JAM  for coaching institute for IIT JAM\n";
                    cout << "  GMAT for coaching institute for GMAT\n";
                    cout << "  GRE for coaching institute for GRE\n";
                    cout << "  NET for coaching institute for ugc-net and csir\n";
                    cout << "  CAT for coaching institute for MBA entrance exam\n";
                    cout << "  UPSC for coaching institute for IAS  exam\n";
        ...
        cout << "\n\nIf you want to continue then type - 'yes':  ";
        string str;
        cin >> str;
        if (str != "yes")
        {
